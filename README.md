...
<!-- Not anymore: - Update BouncyCastle to 1.69 (from 1.47; fixes many vulnerabilities) -->
...
**A**: This mod may work just fine for other MC versions as well. If not: let me know and I will try to provide a proper port!
